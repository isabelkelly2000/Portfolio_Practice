(function () {
  ...
  var query = '*[_type == "project"] | order(order asc) {title, "slug": slug.current, company, role, description, "coverImageUrl": coverImage.asset->url, tags, template}';
  ...
  function createCard(project) {
    ...
    imageInner.className = 'project-image-inner';
